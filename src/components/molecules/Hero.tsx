...
function Hero() {
  ...
  // {`${baseUrl}`}
  return (
    <section className="relative w-full h-svh overflow-hidden lg:max-h-[75vh]">
      <div className="absolute top-0 z-10 p-10 w-full h-full grid max-w-xl lg:p-20">
        ...
        <Link to='/services' className=' border-b-2 border-contrast flex items-center text-balance justify-center gap-2 w-fit text-ligth-2 self-end p-2 hover:scale-110 focus:scale-105 transition-transform duration-300'>
          <span className='w-40'>
